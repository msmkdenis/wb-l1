...
/*
	Адаптер — это структурный паттерн для преобразования интерфейса одного объекта в интерфейс другого.
	Он позволяет использовать объекты с несовместимыми интерфейсами.
